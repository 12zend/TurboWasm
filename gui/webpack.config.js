...
const base = {
    ...
    resolve: {
        symlinks: false,
        alias: {
            'scratch-vm$': path.resolve(__dirname, '../vm/src/index.js'),
...
module.exports = [
    ...
    defaultsDeep({}, base, {
        entry: {
            ...
            'vm-live': './src/playground/vm-live.jsx',
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                filename: 'vm-live.html',
                title: `VM Live - ${APP_NAME}`,
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
