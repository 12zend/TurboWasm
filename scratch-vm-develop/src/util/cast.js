...
const wasmOptimizer = require('./wasm-optimizer');
...
class Cast {
    ...
    static toNumber (value) {
        // If the optimizer is ready, use it for numeric values.
        if (wasmOptimizer.ready && typeof value === 'number') {
            return wasmOptimizer.toNumber(value);
        }
